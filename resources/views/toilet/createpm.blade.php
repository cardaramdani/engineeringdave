...
@section('main-container')
    <h1 align="center" class="my-5" >Form ADD Preventive Toilet</h1>
<table class="table table-bordered table-striped">
<form method="post" action="/toilet/add" >
      @csrf
...
<tr  align="left">
  <th scope="col" colspan="5" class="align-middle">EQUIPMENT : Toilet <br>
    Lokasi Unit.. : <input type="text" name="lokasi_unit" align="left" class="align-left" placeholder="Lokasi Toilet" required> 
  </th>
