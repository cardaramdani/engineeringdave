...
@section('main-container')
    <h1 align="center" class="my-5" >Form Edit Preventive FirePumps</h1>
<table class="table table-bordered table-striped">
<form method="post" action="/pmfirepump/edit/{{$pmfirepumps->id}}" >
      @method('patch')
      @csrf
      <input type="hidden" name="nama" value="{{$pmfirepumps->nama}}">
<tbody>
...
<tr>
        ...
        <td scope="col" align="center" class="font-weight-bold align-middle" colspan="9">
         ...
         <input type="text" class="form-control" value="{{$pmfirepumps->nama}}" required name="nama" id="nama" > 
        </div>
        </td>
        <td scope="col" align="center" class="font-weight-bold align-middle" colspan="9">
          <div class="form-group">
