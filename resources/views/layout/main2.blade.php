  ...
  <body>
    ...
    <div class="wrapper">
          ...
          <li class="item" id="settings">
            ...
            <div class="sub-menu">
                ...
                <a href="#" onclick="event.preventDefault();
                                           document.getElementById('users').submit();"><i class="fas fa-user"></i><span>Users</span></a>
      ...
      <div class="main-container">
        <div class="card">
          <p>eng dave a[t Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
        </div>
        <div class="card">
