...
<form action="/pdam/export" method="post" class="form-inline ">
  @csrf
...
<h1 class="my-2">space</h1>
    <h1 align="center" class="my-5">Form Export Excel</h1>
...
<tbody>
     @php $no=1;  @endphp
    @foreach ($Pdam as $pdam)
   <tr>
        <td scope="col" align="center" class="align-middle font-weight-bold" >{{$no++}}</td>
        <td scope="col" align="center" class="align-middle" >{{$pdam->nama}}</td>
        <td scope="col" align="center " class="align-middle">{{$pdam->shift}}
        <td scope="col" align="center" class="align-middle">{{$pdam->stand}}</td>
        <td scope="col" align="center" class="align-middle">{{$pdam->created_at}}</td>
        @endforeach
</tbody>
    <!-- Optional JavaScript -->
