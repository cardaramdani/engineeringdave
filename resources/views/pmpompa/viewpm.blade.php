...
<tr align="left">
  <th scope="col"   class="align-middle" colspan="5" rowspan="2">
    ...
    Lokasi Unit   : <input type="text" name="lokasi_unit" value="{{$pmpompa->lokasi_unit}}" align="left" class="align-left"> <br>
    Nama Pompa    : <input type="text" name="nama_pompa" value="{{$pmpompa->nama_pompa}}">
  </th>
...
<tr>
        ...
        <td scope="col" align="center" class="font-weight-bold align-middle" colspan="9">
         ...
         <input type="text" class="form-control" value="{{$pmpompa->nama}}" required name="nama" id="nama" readonly> 
        </div>
        </td>
        <td scope="col" align="center" class="font-weight-bold align-middle" colspan="9">
          <div class="form-group">
