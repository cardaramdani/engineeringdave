...
@section('main-container')
    <h1 align="center" class="my-5" >Form ADD Preventive Pompa</h1>
<table class="table table-bordered table-striped">
<form method="post" action="/pmpompa/add" >
      @csrf
...
<tr class="align-left" align="left">
  <th scope="col" colspan="5" >EQUIPMENT : Pompa-pompa <br>
    Lokasi Unit : <input type="text" name="lokasi_unit" align="left" class="align-left"> <br>
    Nama Pompa  : <input type="text" name="nama_pompa">
