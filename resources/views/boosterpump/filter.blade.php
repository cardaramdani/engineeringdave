...
<html lang="en">
  <head>
    ...
    <title>Filter Boosterpump</title>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form action="/boosterpump/export" method="post" class="form-inline ">
      
      @csrf
      
      <div class="custom-date ">
            <label for="startdate" class="text-light">Start Sate</label>
...
<tr>        
        ...
        <td scope="col" align="center"  class="align-middle">{{$boosterpump->spv}}</td>
</tr>
@endforeach
    </tbody>
